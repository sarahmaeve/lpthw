...
# original exercise says "figure it out" but too much is
# left unexplored

# LPTHW's original: (gave up and started cutting and pasting the paragraphs of
# nonsense)

# not finishing this not very useful exercise
...
class CentralCorridor(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            teeth, and evil clown costume flowing round his hate filled
        ...
        if action == "shoot!":
            ...
            around his body, whih throws off your aim. Your laser
